...
else
{
 ...
 //Datos para mostrar el gráfico de barras de las ventas de los ultimos 12 meses
  ...
  <script type="text/javascript">
    ...
    var compras = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label: '# Compras en $ Pesos de los últimos 10 días',
    ...
    var ventas = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label: 'Ventas en $ Pesos de los últimos 12 meses',

<!-- Validar si la sesion esta activa si no volverla a iniciar-->
<?php
          ...
          <ul class="sidebar-menu">
            ...
            if ($_SESSION['escritorio']==1)
            {
              ...
              <a href="estadisticas.php">
                <i class="fa fa-tasks"></i> <span>Estadística</span>
              </a>
              </li>';
            }?>
             <?php
            ...
            <?php
              if ($_SESSION['consultac']==1)
              {
                    echo '<li class="treeview">
                    <a href="#">
                      <i class="fa fa-bar-chart"></i> <span>Consulta de Compras</span>
                      <i class="fa fa-angle-left pull-right"></i>
                    </a>
                    <ul class="treeview-menu">

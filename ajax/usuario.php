...
switch ($_GET["op"]){
    case 'guardaryeditar':
        //Si no se ha seleccionado un archivo y no se ha cargado una imagen
        ...
        if (empty($idusuario)){
            ...
            echo $rspta ? "Trabajador registrado" : "Trabajador no se pudo registrar todos los datos";
        }
        else {//EDITAR
    ...
    case 'desactivar':
        ...
        echo $rspta ? "Trabajador Desactivado" : "Trabajador no se puede desactivar";
        break;
    break;
    ...
    case 'permisos':
            ...
            while ($reg = $rspta->fetch_object())
            {
                $sw=in_array($reg->idpermiso,$valores)?'checked':'';        //compara valores

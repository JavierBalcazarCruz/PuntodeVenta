    ...
    public function listarActivos()
    {
     ...
     public function listarActivosVenta()
     {
         ...
         (SELECT precio_venta FROM detalle_ingreso 
          ...
          ORDER BY iddetalle_ingreso desc limit 0,1)
          as precio_venta, a.descripcion,a.imagen,a.condicion FROM articulo a INNER JOIN categoria c ON a.idcategoria=c.idcategoria 
          WHERE a.condicion='1'";
         return ejecutarConsulta($sql);      
     }
}
